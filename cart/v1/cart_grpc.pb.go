...
const (
	ShoppingCartService_GetCart_FullMethodName    = "/cart.v1.ShoppingCartService/GetCart"
	ShoppingCartService_AddItem_FullMethodName    = "/cart.v1.ShoppingCartService/AddItem"
	ShoppingCartService_UpdateItem_FullMethodName = "/cart.v1.ShoppingCartService/UpdateItem"
	ShoppingCartService_RemoveItem_FullMethodName = "/cart.v1.ShoppingCartService/RemoveItem"
	ShoppingCartService_ClearCart_FullMethodName  = "/cart.v1.ShoppingCartService/ClearCart"
)
...
func (c *shoppingCartServiceClient) ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*ClearCartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// UnimplementedShoppingCartServiceServer should be embedded to have
...
func (UnimplementedShoppingCartServiceServer) ClearCart(context.Context, *ClearCartRequest) (*ClearCartResponse, error) {
...
var ShoppingCartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cart.v1.ShoppingCartService",
