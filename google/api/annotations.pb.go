...
const file_google_api_annotations_proto_rawDesc = "" +
	...
	"\x04http\x12\x1e.google.protobuf.MethodOptions\x18\xb0ʼ\" \x01(\v2\x14.google.api.HttpRuleR\x04httpB\xa4\x01\n" +
	"\x0ecom.google.apiB\x10AnnotationsProtoP\x01Z7github.com/nexus-commerce/nexus-contracts-go/google/api\xa2\x02\x03GAX\xaa\x02\n" +
	"Google.Api\xca\x02\n" +
