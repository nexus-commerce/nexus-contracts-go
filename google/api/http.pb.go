...
const file_google_api_http_proto_rawDesc = "" +
	...
	"\x04path\x18\x02 \x01(\tR\x04pathB\x9d\x01\n" +
	"\x0ecom.google.apiB\tHttpProtoP\x01Z7github.com/nexus-commerce/nexus-contracts-go/google/api\xa2\x02\x03GAX\xaa\x02\n" +
	"Google.Api\xca\x02\n" +
